...
public class DependencyRelnDepModel
{
	...
	public static void main(String[] args)
	{
		...
		//depModel.test();
		DependencyRelnDepModel.make();
	}
	public DependencyRelnDepModel()
	{
		depCounter = CompressedCounterFactory.load("C:/MissingWord/dep/relnDep.txt", mc);
	}
	...
	private static void make()
	{
		...
		multitasker.done();
		depCounter.export("C:/MissingWord/dep/relnDep.txt");
	}
		...
		public void read(String line) 
		{
			...
			for(String depChunk : line.split("@"))
			{
				try
				{
					...
					depCounter.add(dep.getRelation(), dep.getDepToken());
				}
				catch(Exception e)
				{
					e.printStackTrace();
